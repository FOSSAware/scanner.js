Thank you for considering contributing to scanner.js. It's people like you that make scanner.js such a great tool. Feel welcome and read the following sections in order to know how to get involved, ask questions and more importantly how to work on something.

scanner.js is an open source project and we love to receive contributions from our community. There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests, or writing code.
...
- Version of scanner.js you are using
- Linux OS Version
- GCC version
